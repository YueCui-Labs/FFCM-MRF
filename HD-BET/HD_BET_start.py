...
def HD_BET_run(input_path,output_path,in_mode='fast',in_device='cpu',in_tta=0,is_save_mask=1,is_overwrite_existing=1,is_pp=0):
    print("\n########################")
    ...
    tta = in_tta
    pp = is_pp
    save_mask = is_save_mask
    overwrite_existing = is_overwrite_existing
